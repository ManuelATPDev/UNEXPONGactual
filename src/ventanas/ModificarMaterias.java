...
public class ModificarMaterias extends javax.swing.JFrame {
    String materia_codigo = "", materia_nombre = "", materia_seccion = "", user, especialidad_update, materias;
    int ID_update;
    String[] user2;
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        int validacion = 0;
        materias = InformacionAlumnos.materias;

        //Modificar
        if (materias.contains(materia_seccion) && !materia_seccion.equals(cmb_seccion_materia.getSelectedItem().toString())) {

            materias = materias.replaceAll(materia_seccion, cmb_seccion_materia.getSelectedItem().toString());
        } else {
