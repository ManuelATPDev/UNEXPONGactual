...
public class ValidadorConPatron {
    ...
    public ValidadorConPatron(String palabra) {
         ...
         * también numeros desde el 0 hasta el 9 "0-9" igual que _ y - y debe
         * encontrar más caracteres seguidos a este "\\+" repetidos 1 o más
         * veces "+"
         *
         ...
         *
         * (\\.[A-Za-z]{2,})$ = Forzosamente debe la cadena de caracteres debe
